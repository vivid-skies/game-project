...
func _process(delta: float) -> void:
	...
	if left_pos.y > 0 and Input.is_action_pressed("up"):
		left_pos.y += -PAD_SPEED * delta
	if left_pos.y < screen_size.y and Input.is_action_pressed("down"):
		left_pos.y += PAD_SPEED * delta
	...
	if right_pos.y > 0 and Input.is_action_pressed("up"):
		right_pos.y += -PAD_SPEED * delta
	if right_pos.y < screen_size.y and Input.is_action_pressed("down"):
		right_pos.y += PAD_SPEED * delta
